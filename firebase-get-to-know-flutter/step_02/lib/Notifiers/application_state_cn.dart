...
class ApplicationState extends ChangeNotifier {
  ...
  Future<void> init() async {
    ...
    FirebaseAuth.instance.userChanges().listen((user) {
      if (user != null) {
       ...
       _attendingSubsription = FirebaseFirestore.instance
            .collection('attendees')
            .doc(user.uid)
            .snapshots()
            .listen((snapshot) {
  ...
  StreamSubscription<DocumentSnapshot>? _attendingSubsription;
